...
export const WeeklyWrappedCard = memo(function WeeklyWrappedCard({ data: initialData }: WeeklyWrappedCardProps) {
  ...
  if (loading) {
    return (
      <div className="bg-[#101026] border border-white/5 rounded-2xl p-6 flex items-center justify-center min-h-[140px] text-muted-foreground select-none">
        <Loader2 className="h-6 w-6 animate-spin text-primary mr-2" />
        <span className="text-xs font-bold uppercase tracking-wider">Unwrapping your week...</span>
      </div>
    );
  }
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="relative bg-gradient-to-r from-[#170E3A] via-[#101026] to-[#25091C] border border-primary/20 rounded-2xl p-5 shadow-2xl overflow-hidden select-none"
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 p-1 rounded-lg bg-black/40 hover:bg-white/10 text-muted-foreground hover:text-white border border-white/5 transition-all cursor-pointer z-10"
        ...
        <div className="relative space-y-4">
          ...
          <div className="flex items-center gap-2 text-primary font-black select-none">
            ...
            <span className="text-[12px] uppercase tracking-widest font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-primary">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 pt-2">
            ...
            {/* Stat: Count */}
            <div className="bg-black/20 border border-white/5 rounded-xl p-3 flex items-start gap-3">
              <div className="p-2 bg-blue-500/10 rounded-lg text-blue-400 shrink-0 mt-0.5 border border-blue-500/10">
                <Film className="h-4 w-4" />
              </div>
              <div className="min-w-0">
                <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider block">Logged</span>
            ...
            <div className="bg-black/20 border border-white/5 rounded-xl p-3 flex items-start gap-3">
              ...
              <div className="min-w-0">
                <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider block">Time Spent</span>
                <span className="text-[14px] font-extrabold text-white">
            ...
            <div className="bg-black/20 border border-white/5 rounded-xl p-3 flex items-start gap-3">
              ...
              <div className="min-w-0">
                <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider block">Avg Rating</span>
                <span className="text-[14px] font-extrabold text-white">
                  ★ {data.avgRating}
                </span>
              </div>
            ...
            <div className="bg-black/20 border border-white/5 rounded-xl p-3 flex items-start gap-3">
              ...
              <div className="min-w-0">
                <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider block">Top Genre</span>
