    ...
    <section className="space-y-3 select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {Array.from({ length: 3 }).map((_, idx) => (
          <Card key={idx} className="border-border/30 bg-card/25 backdrop-blur-md overflow-hidden rounded-xl h-36 animate-pulse">
            <CardContent className="p-4 flex flex-col justify-between h-full">
              ...
              <div className="flex items-center pl-2 relative h-16">
                ...
                <div className="relative h-16 aspect-[2/3] rounded-md bg-muted/20 border border-black/50 shadow-xl" />
                <div className="relative h-16 aspect-[2/3] rounded-md bg-muted/15 border border-black/50 shadow-xl -ml-2" />
                <div className="relative h-16 aspect-[2/3] rounded-md bg-muted/10 border border-black/50 shadow-xl -ml-2" />
